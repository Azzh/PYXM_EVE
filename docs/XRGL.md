...
>  客服恢复流程有2个，一个是自动快速流程，优先用这个，在爆船1小时左右就能申请，然后半小时内就能把东西邮件给你。还一个是人工普通流程（PVP只能走这个流程），需要提交工单，答复比较慢。两种申请方式在群文件夹里都有截图攻略。客服恢复是有间隔时间的，打怪被爆的船15天可申请客服恢复1艘（势力或T8以上30天）。如果是PVP被人打爆，30天恢复1艘（需要有合理理由，比如手机黑屏，掉线连不上，武器按钮失效等）。
