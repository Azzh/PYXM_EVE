...
>  **苹果版**，需要去淘宝/京东购买apple美区定额礼品卡（搜索IOS美区AppStore礼品卡，都是自动发货），购买后将卡密输入AppStore的充值界面给之前购买的美区appleID充上值，之后在游戏中内购即可（注意如果游戏内购买报error3的错，请打电话联系中国的苹果客服，他给你关一个安全风险设置即可，或者先买几个便宜app等一天自动解禁）。当然最方便的是找个安卓手机或者电脑，从安卓端登录自己的游戏账号（需要先将游 戏账号增加绑定VK），因为安卓端支持微信/支付宝充值。
